...
public class BowlTest {
    ...
    public void seventhBowlShouldBeKalahaBowl() {
        Bowl firstBowl = new NormalBowl(player1, player2);
    ...
    public void opponentIsCorrectlyAssignedAsWinner() {
        ...
        NormalBowl loadedGame = new NormalBowl(expectedGameState, player1, player2);
    ...
    public void checkPlayer1IsWinnerButGameHasNotEndedYet() {
        NormalBowl normalBowl = new NormalBowl(player1, player2);
    ...
    public void gameIsTieReturnCorrectly() {
        ...
        assertEquals("", winningPlayer.getName());
    }
    ...
    public void gameStateCorrectFormat() {
        NormalBowl newGame = new NormalBowl(player1, player2);
        newGame.doMove();
    ...
    public void gameStateCorrectlyLoaded() {
        NormalBowl expectedGameState = new NormalBowl(player1, player2);
        ...
        NormalBowl loadedGame = new NormalBowl(gameState, player1, player2);
