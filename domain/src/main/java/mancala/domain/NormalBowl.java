...
public class NormalBowl extends Bowl {
    ...
    public NormalBowl(String namePlayer1, String namePlayer2) {
        super(namePlayer1, namePlayer2);
    }

    public NormalBowl(String gameState, String namePlayer1, String namePlayer2) {
        super(gameState, namePlayer1, namePlayer2);
    }
