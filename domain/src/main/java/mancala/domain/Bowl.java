...
public abstract class Bowl {
    ...
    public Bowl(String namePlayer1, String namePlayer2) {
        int nrOfCurrentBowl = 1;
        this.nrOfSeedsInBowl = STARTING_NR_OF_SEEDS_IN_BOWL;
        this.bowlOwner = new Player(namePlayer1, namePlayer2);
    ...
    public Bowl(String gameStateToLoadIn, String namePlayer1, String namePlayer2) {
        int nrOfCurrentBowl = 1;
