...
public class MancalaControllerTest {
    ...
    @Test
    public void testStartGameWithoutRequestBody() {
        Response response = controller.start(mockRequest, null);
        assertEquals(400, response.getStatus());
    }

    @Test
    public void testPlayMoveWithoutRequestBody() {
        Response response = controller.play(mockRequest, null);
        assertEquals(400, response.getStatus());
    }
