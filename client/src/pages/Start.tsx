...
export const Start = () => {
    ...
    const valid = player1 !== "" && player2 !== "" && player1 !== player2 && player1.length <= 15 && player2.length <= 15;
                    ...
                    <div className="text-white">
                        ...
                        <form>
                            ...
                            <FloatingInput
                                ...
                                hasError={
                                    (player1 !== "" && player2 !== "" && player1 === player2) || player1.length > 15
                                }
                            />
                        </li>
                        <li className="mt-4">
                            <FloatingInput
                                ...
                                hasError={
                                    (player1 !== "" && player2 !== "" && player1 === player2) || player2.length > 15
                                }
                            />
                        </li>
                        <li>
                            {player1 && player2 && (player1 === player2 || player1.length > 15 || player2.length > 15) && (
                                <p className="mt-2 text-sm text-red-400">
                                    <span className="font-medium">Names must be unique and no longer than 15 characters</span>
                                </p>
                            )}
                        </li>
